...
Schema = (function(_super) {
  ...
  Schema.prototype.configure = function(model) {
    ...
    this.title.html("" + this.model + "'s Schema");
    SchemaModel.fetch({
      url: "/schema/" + this.model
    });
    return this.active();
